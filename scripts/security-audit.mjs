...
const checks = [
 ...
 ['Pages API URL has a trusted HTTPS production fallback', read('.github/workflows/deploy.yml').includes('VITE_API_BASE_URL="${VITE_API_BASE_URL:-https://restaurantos-xqi52dpwgo-as.a.run.app}"')],
