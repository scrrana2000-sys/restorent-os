        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-2xs">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <button
              ...
              onClick={handleBack}
              className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors min-h-[44px]"
            >
        ...
        <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-6 space-y-6">
          ...
          {!isLoading && !error && !notFound && restaurant && (
            <div id={`restaurant-profile-${restaurant.restaurantId}`} className="space-y-6">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs bg-slate-900">
                  ...
                  <div className="absolute top-4 left-4">
                    {isOpenForOrders ? (
                      <span
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-500 text-white shadow-md backdrop-blur-md"
                      >
                      ...
                      <span
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-amber-500 text-white shadow-md backdrop-blur-md"
                      >
                      ...
                      <span
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-slate-700 text-slate-200 shadow-md backdrop-blur-md"
                      >
                      ...
                      <span
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-blue-600 text-white shadow-md backdrop-blur-md"
                      >
                ...
                {/* Profile Header Bar */}
                <div className="bg-white p-6 pt-0 relative">
                  {/* Floating Logo */}
                  <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-10 sm:-mt-12 mb-4">
                    <div className="flex items-end gap-4">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-white border-4 border-white shadow-lg overflow-hidden flex items-center justify-center shrink-0">
                        {restaurant.logoUrl ? (
                          <img
                    ...
                    <div className="pt-2 sm:pt-0 shrink-0">
                      <button
                        ...
                        className="w-full sm:w-auto px-6 py-3 bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-bold text-sm rounded-2xl shadow-md shadow-orange-600/20 transition-all flex items-center justify-center gap-2 min-h-[44px]"
                      >
                        <span>View Menu</span>
                  ...
                  {restaurant.cuisine && restaurant.cuisine.length > 0 && (
                    <div id="profile-cuisine-tags" className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100">
