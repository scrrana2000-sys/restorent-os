          ...
          <div className="flex items-start justify-between gap-1.5">
            ...
            {onToggleAvailability && (
              <button
                ...
                className={'shrink-0 min-h-[44px] min-w-[44px] px-1.5 rounded-md border text-[9px] font-black flex items-center justify-center gap-1 transition-colors ' +
                  (item.isAvailable
        ...
        <div className="pt-0.5">
          {quantityInCart > 0 && onUpdateQuantity ? (
            ...
            <button
              ...
              onClick={handleIncrement}
              className={`w-full min-h-[44px] px-2 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-1 transition-all active:scale-95 ${
                item.isAvailable
