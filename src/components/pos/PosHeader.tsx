      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          {(onOpenMobileMenu || (window as any).openAdminMobileMenu) && (
            <button
              ...
              onClick={onOpenMobileMenu || (window as any).openAdminMobileMenu}
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              id="pos-header-user-profile-btn"
              type="button"
              onClick={() => setIsProfileOpen(!isProfileOpen)}
              className="flex items-center gap-1 pl-0.5 p-1 rounded-lg hover:bg-slate-100 transition-colors focus:outline-none min-h-[36px]"
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        console.error('POS Header Logout error:', err);
                      }
                    }}
